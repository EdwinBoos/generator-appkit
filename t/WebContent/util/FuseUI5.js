jQuery.sap.declare("enter.some.module.name.util.FuseUI5");
jQuery.sap.require("enter.some.module.name.util.Proxy");
 ...
 *
 *
 * @class {enter.some.module.name.util.FuseUI5}
 * @author Boos Edwin.
 * @date 30.11.2016
 * @version: 0.0.1
 *
 ...
 *
 */
enter.some.module.name.util.FuseUI5 = class extends Fuse {
  /**
   *
  ...
  constructor(list = [], options = {}) {
    super(list, options);
    this.proxy = new enter.some.module.name.util.Proxy(list, options);
  }
   ...
   *
   * @returns {enter.some.module.name.util.FuseUI5} for method chaining.
   */
  reset() {
    this.proxy.reset();
   ...
   *
   * @param list {Array}
   * @returns {enter.some.module.name.util.Proxy} for method chaining.
   */
  setListOnce(list) {
