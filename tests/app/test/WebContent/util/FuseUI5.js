jQuery.sap.declare("de.test.util.FuseUI5");
jQuery.sap.require("de.test.util.Proxy");
 ...
 *
 */
de.test.util.FuseUI5 = class extends Fuse {
  /**
   *
  ...
  constructor(list = [], options = {}) {
    super(list, options);
    this.proxy = new de.test.util.Proxy(list, options);
  }
   ...
   *
   * @returns {de.test.util.FuseUI5} for method chaining.
   */
  reset() {
    this.proxy.reset();
   ...
   *
   * @param list {Array}
   * @returns {de.test.util.Proxy} for method chaining.
   */
  setListOnce(list) {
